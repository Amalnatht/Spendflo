...
Scenario: User logs in navigates to wf page
    Given Superadmin "Amalnath" logs in to "prod" and switches to "test-org" organization
    ...
    Then User hovers over the approval task for csm and creates a new completion task for Requester's manager to the bottom
    ...
    Then User hovers over the approval task for selecteduser and creates a new completion task for Engagement Manager to the bottom
    ...
    Then User hovers over the approval task for requester and creates a new completion task for requester to the bottom
    Then User hovers over the completion task for requester and creates a new approval task for Requester's Team owner to the bottom
    Then User hovers over the withoutchecklist task  and creates a new completion task for Requester's Team owner to the bottom
